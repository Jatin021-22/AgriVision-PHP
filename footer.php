...
<footer class="footer-area section-padding-80-0">
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-footer-widget mb-80">
                    ...
                    <div class="footer-content mb-15">
                        <h3 style="font-size:25px;">(+121) 909 349 9818</h3>
                        <p>
                            Plot 206 ,chandani chowk , A10, Nikole  , Ahmedabad. <br />
                            <a style="color:#1583e9;"
                                href="mailto:admin@greenandstretchfarms.com">admin@agrivision.com</a>
                        </p>
                    </div>
                    <p class="mb-0">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-footer-widget mb-80">
                    ...
                    <p>
                        We believe in delivering our produce right from the harvest to the homes of our end customers
                    </p>
        ...
        <div class="row" style="margin-bottom: 30px;margin-left:2px;">
            ...
            - &nbsp;
            AgriVision Growing a Better Tomorrow
        </div>
    </div>
</footer>
<!-- ***** Footer Area End ***** -->
